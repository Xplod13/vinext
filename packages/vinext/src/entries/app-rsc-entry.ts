...
// Re-exported so the App Router prod-server can strip basePath before
// recognising /_next/static/* paths (parity with the Pages Router server's
// vinextConfig.basePath export).
